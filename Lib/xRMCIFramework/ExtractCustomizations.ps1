...
#Solution Packager
#$extractOuputText =  $solutionPackager + " /action:Extract /zipfile:" + $env +":TEMP\" + $unmanagedSolution +" /folder:" + $solutionFilesFolder +" /packagetype:Both /errorlevel:Info /allowWrite:Yes /allowDelete:Yes /map:" + $mappingFile
#Write-Output "Extract Command: $extractOuputText"
